      ...
      <div className="bg-white border rounded-lg overflow-hidden">
        ...
        <table className="w-full text-sm">
          <tbody>
            ...
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              <td className="font-semibold p-3 text-right md:w-1/5">brand</td>
            ...
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              <td className="font-semibold p-3 text-right md:w-1/5">series</td>
              <td className="p-3">{card.series}</td>
            </tr>
            <tr className="odd:bg-gray-100 even:bg-white border-t">
            ...
            <tr className="odd:bg-gray-100 even:bg-white border-t">
              <td className="font-semibold p-3 text-right md:w-1/5">grade</td>
              <td className="p-3">{card.grade}</td>
            </tr>
            <tr className="odd:bg-gray-100 even:bg-white border-t">
