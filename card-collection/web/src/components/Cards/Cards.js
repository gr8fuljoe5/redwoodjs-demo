      ...
      <table className="table-auto w-full min-w-3xl text-sm">
        <thead>
          <tr className="bg-gray-300 text-gray-700">
            ...
            <th className="font-semibold text-left p-3">series</th>
            <th className="font-semibold text-left p-3">number</th>
            <th className="font-semibold text-left p-3">grade</th>
        ...
        <tbody>
          {cards.map((card) => (
            ...
            >
              ...
              <td className="p-3">{truncate(card.name)}</td>
              <td className="p-3">{truncate(card.brand)}</td>
              <td className="p-3">{truncate(card.year)}</td>
              <td className="p-3">{truncate(card.series)}</td>
              <td className="p-3">{truncate(card.number)}</td>
              <td className="p-3">{truncate(card.grade)}</td>
