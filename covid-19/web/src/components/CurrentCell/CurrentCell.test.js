...
import { Loading, Empty, Failure, Success } from './CurrentCell'
...
describe('CurrentCell', () => {
  ...
  it('Success renders successfully', () => {
    render(
      <Success userExample={{ current: { objectKey: 'objectValue' } }} />
    )
    expect(
      screen.queryByText('{"current":{"objectKey":"objectValue"}}')
    ).toBeInTheDocument()
  })
})
